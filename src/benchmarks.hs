module Main (main) where
    ...
    main = defaultMain [
       ...
       {- bgroup "fermat" [ bench "46382" $ whnf fermat (46382 :: Integer)
                   , bench "768480" $ whnf fermat (768480 :: Integer)
                   ...
                   , bench "65398261922" $ whnf fermat (65398261922 :: Integer)
                   , bench "364879542900" $ whnf fermat (364879542900 :: Integer)
                   , bench "8590365927554" $ whnf fermat (8590365927554 :: Integer)
                   , bench "28564333765950" $ whnf fermat (28564333765950 :: Integer)
                   , bench "12345678910112" $ whnf fermat (12345678910112 :: Integer)
                   ]-}
        {-bgroup "rho" [ bench "46382" $ whnf rhoPollard (46382 :: Integer)
                   , bench "768480" $ whnf rhoPollard (768480 :: Integer)
                   ...
                   , bench "65398261922" $ whnf rhoPollard (65398261922 :: Integer)
                   , bench "364879542900" $ whnf rhoPollard (364879542900 :: Integer)
                   , bench "8590365927554" $ whnf rhoPollard (8590365927554 :: Integer)
                   , bench "28564333765950" $ whnf rhoPollard (28564333765950 :: Integer)
                   , bench "12345678910112" $ whnf rhoPollard (12345678910112 :: Integer)
                   ]-}
        ]
